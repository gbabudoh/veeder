...
export function RegisterScreen({ onGoToLogin }: RegisterScreenProps): React.JSX.Element {
  ...
  async function handleSubmit(): Promise<void> {
    // Client-side validation — no request sent if empty.
    let valid = true;
    ...
    switch (result.reason) {
      case 'already_exists':
        ...
        break;
      case 'invalid_input':
        setServerMessage('Invalid email or password format.');
        break;
      case 'rate_limited':
        setServerMessage('Too many attempts — please try again later.');
        break;
      case 'network_error':
